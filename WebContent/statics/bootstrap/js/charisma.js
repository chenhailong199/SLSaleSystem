$(document).ready(function () {
	...
	for (var i=0; i<json.length; i++){
		var arrs = new Array("glyphicon glyphicon-home","glyphicon glyphicon-eye-open","glyphicon glyphicon-list-alt","glyphicon glyphicon-font","glyphicon glyphicon-picture","glyphicon glyphicon-calendar","glyphicon glyphicon-globe","glyphicon glyphicon-ban-circle");
		//配置主菜单
		...
		for (var j=0; j<json[i].subMenu.length; j++){
			result = result + '<li><a href="#">'+json[i].subMenu[j].functionName+'</a></li>';
		}
		result = result+'</ul>';
	}
	$("#menus").append(result);
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            ...
            $('#bs-css').attr('href', 'statics/bootstrap/css/bootstrap-' + themeName + '.min.css');
        }
