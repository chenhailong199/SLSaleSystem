	...
	if(ok){
		str = "<div id=\"selectdiv\"><label class=\"goodsname\">"+goodsname+"</label>"+
				"<label class=\"goodscount\"><input class=\"finalresult\" goodsid=\""+id+"\" rprice=\""+rprice+"\" type=\"text\" value=\"1\"/></label>"+
						"<label class=\"del\" rprice=\""+rprice+"\"><img src=\"/SL/statics/bootstrap/img/cancel-on.png\"/></label>"+
...
$("#a_goodsPackCode").blur(function(){
	...
	if(agpc != ""){
		$.post("/SL/backend/goodspackcodeisexit.html",{'goodsPackCode':agpc,'id':'-1'},function(result){
			if(result == "repeat"){
