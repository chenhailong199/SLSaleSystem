...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/informanage/affiche.html">公告管理</a></li>
	</ul>
</div>
					  ...
					  <c:choose>
						...
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SL/informanage/affiche.html?p=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
	...
	<div class="modal hide fade" id="addAfficheDiv">
		<form action="/SL/informanage/addAffiche.html" enctype="multipart/form-data" method="post" onsubmit="return addAfficheFunction();">
	 ...
	 <div class="modal hide fade" id="modifyAfficheDiv">
		<form action="/SL/informanage/modifyAffiche.html" enctype="multipart/form-data" method="post" onsubmit="return modifyAfficheFunction();">
			<div class="modal-header">
				<button type="button" class="close addusercancel" data-dismiss="modal">×</button>
				<h3>修改公告信息</h3>
...
<script type="text/javascript" src="/statics/local/js/affiche.js"></script> 
