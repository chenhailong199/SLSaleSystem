...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/informanage/portalafficheList.html">公告列表</a></li>
	</ul>
</div>
					...
					<div class="pagination pagination-centered">
					  <ul>
						<c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SL/informanage/portalafficheList.html?p=1" title="首页">首页</a></li>
					  	</c:otherwise>
					   </c:choose>
						<c:if test="${page.prevPages!=null}">
							<c:forEach items="${page.prevPages}" var="num">
								<li><a href="/SL/informanage/portalafficheList.html?p=${num}"
						...
						<c:if test="${page.nextPages!=null}">
							<c:forEach items="${page.nextPages}" var="num">
								<li><a href="/SL/informanage/portalafficheList.html?p=${num}" title="${num}">
								${num} </a></li>
							</c:forEach>
						</c:if>
						<c:if test="${page.pageCount !=null}">
							<c:choose>
						  	...
						  	<c:otherwise>
						  	<li><a href="/SL/informanage/portalafficheList.html?p=${page.pageCount}" title="尾页">尾页</a></li>
						  	</c:otherwise>
						    </c:choose>
					    </c:if>
						<c:if test="${page.pageCount == null}">
