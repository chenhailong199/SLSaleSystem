...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/member/modifypersonalinfo.html">修改本人资料</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="/SL/member/savepersonalinfo.html" enctype="multipart/form-data" method="post" onsubmit="return modifyPersonalInfoFunc();">
...
<script type="text/javascript" src="/statics/local/js/modifypersonalinfo.js"></script> 
