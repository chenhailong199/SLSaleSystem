...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/member/registok.html">会员注册成功</a></li>
	</ul>
</div>
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<p class="right">
							<button class="btn btn-large btn-primary nextbtn" disabled=""><i class="icon-chevron-left icon-white"></i>报单购货</button>
						</p>
...
<script type="text/javascript" src="/statics/local/js/registok.js"></script> 
