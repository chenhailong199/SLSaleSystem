...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/member/registmember.html">会员注册</a></li>
	</ul>
</div>
			<div class="row-fluid sortable">		
				...
				<form action="/SL/member/saveregistmember.html" enctype="multipart/form-data" method="post" onsubmit="return registMemberFunc();">
...
<script type="text/javascript" src="/statics/local/js/registmember.js"></script> 