...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/backend/addgoodspack.html">添加商品套餐</a></li>
	</ul>
</div>
			...
			<legend>添加商品套餐</legend>
                 <form action="/SL/backend/saveaddgoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return addGoodsPackFunc();">
...
<script type="text/javascript" src="/SL/statics/local/js/addgoodspack.js"></script> 
