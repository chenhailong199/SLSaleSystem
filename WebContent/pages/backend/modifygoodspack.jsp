...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/backend/modifygoodspack.html">修改商品套餐</a></li>
	</ul>
</div>
			...
			<legend>修改商品套餐</legend>
                 <form action="/SL/backend/savemodifygoodspack.html" class="form-horizontal" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsPackFunc();">
					...
					<div class="control-group">
					  ...
					  <div class="controls">
						<ul class="aboutproductsList">
						  	<li><iframe id="goodsListFrame" class="goodsListFrame" src="/SL/backend/goodslist.html"></iframe></li>
						  	<li id="selectgoodslist">
						  		<c:if test="${goodsList != null}">
									...
									<label class="del" rprice="${goods.realPrice}"><img src="/SL/statics/bootstrap/img/cancel-on.png"/></label>
...
<script type="text/javascript" src="/SL/statics/local/js/modifygoodspack.js"></script> 
