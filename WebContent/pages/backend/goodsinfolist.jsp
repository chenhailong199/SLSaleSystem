...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/backend/goodsinfolist.html">商品管理</a></li>
	</ul>
</div>
		...
		<div class="row-fluid sortable">		
			<div class="box span12">
				...
				<div class="box-content">
					<form action="/SL/backend/goodsinfolist.html" method="post">
				...
				<div class="pagination pagination-centered">
				  <ul>
				   <c:choose>
				  	...
				  	<c:otherwise>
				  	<li><a href="/SL/backend/goodsinfolist.html?currentpage=1&s_goodsName=${s_goodsName}&s_state=${s_state}" title="首页">首页</a></li>
				  	</c:otherwise>
				  </c:choose>
					
					<c:if test="${page.prevPages!=null}">
						<c:forEach items="${page.prevPages}" var="num">
							<li><a href="/SL/backend/goodsinfolist.html?currentpage=${num}&s_goodsName=${s_goodsName}&s_state=${s_state}"
					...
					<c:if test="${page.nextPages!=null}">
						<c:forEach items="${page.nextPages}" var="num">
							<li><a href="/SL/backend/goodsinfolist.html?currentpage=${num}&s_goodsName=${s_goodsName}&s_state=${s_state}" title="${num}">
							${num} </a></li>
						</c:forEach>
					</c:if>
					<c:if test="${page.pageCount !=null}">
						<c:choose>
					  	...
					  	<c:otherwise>
					  	<li><a href="/SL/backend/goodsinfolist.html?currentpage=${page.pageCount}&s_goodsName=${s_goodsName}&s_state=${s_state}" title="尾页">尾页</a></li>
					  	</c:otherwise>
					    </c:choose>
				    </c:if>
					<c:if test="${page.pageCount == null}">
	...
	<div class="modal hide fade" id="addGoodsInfoDiv">
		<form action="/SL/backend/addgoodsinfo.html" enctype="multipart/form-data" method="post" onsubmit="return addGoodsInfoFunction();">
	...
	<div class="modal hide fade" id="modifyGoodsInfoDiv">
		<form action="/SL/backend/modifygoodsinfo.html" enctype="multipart/form-data" method="post" onsubmit="return modifyGoodsInfoFunction();">
			<div class="modal-header">
	...
	<div class="modal hide fade" id="viewGoodsInfoDiv">
			...
			<div class="modal-body">
				...
				<div class="clear"></div>
					<ul class="downul">
					<li>
					<span>商品规格：</span> &nbsp;&nbsp;&nbsp;&nbsp;<div id="v_goodsFormat" readonly="readonly" rows="3"></div>
					</li>
				    </ul>
					<ul class="downul">
					<li>
					<span>商品说明：</span> &nbsp;&nbsp;&nbsp;&nbsp;<div id="v_note" readonly="readonly" rows="3"></div>
					</li>
				    </ul>
			</div>
			<div class="modal-footer">
...
<script type="text/javascript" src="/SL/statics/local/js/goodsinfolist.js"></script> 
