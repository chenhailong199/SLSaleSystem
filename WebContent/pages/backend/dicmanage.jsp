...
<div>
	<ul class="breadcrumb">
		...
		<li><a href="/SL/backend/dicmanage.html">数据字典管理</a></li>
	</ul>
</div>
				...
				<div class="box span12">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <li class="addDicBtn">
						  		<img src="/SL/statics/bootstrap/img/ico7.png"/>
						  </li>
						  <c:forEach items="${dataList}" var="dl">
						  	<li class="maintitle">
						  		...
						  		<span class="mainset">
									<img class="modifyMainDic" dictypename="${dl.typeName}" dicid="${dl.id}" dictypecode="${dl.typeCode}" src="/SL/statics/bootstrap/img/ico10.png"> <img class="delMainDic" dictypecode="${dl.typeCode}" dictypename="${dl.typeName}" src="/SL/statics/bootstrap/img/linkdel.png">
								</span>
						  	</li>
						  </c:forEach>
						  <li class="addDicBtn">
						  ...
						  <div class="dicListContent">
							...
							-->
						  	...
						  	<ul id="addsubdicul">
						  		<li id="addDicLiBtn" class="addDicLiBtn"><img src="/SL/statics/bootstrap/img/winapp_add.png"/></li>
						  	</ul>
						  </div>
...
<script type="text/javascript" src="/SL/statics/local/js/dicmanage.js"></script>