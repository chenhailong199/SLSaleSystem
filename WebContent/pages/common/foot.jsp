<%@ page language="java" import="java.util.*" pageEncoding="UTF-8"%>
	...
	<script src="/SL/statics/bootstrap/js/json2.js"></script>
	
	<script src="/SL/statics/bootstrap/js/ajaxfileupload.js"></script>

	<script type="text/javascript" src="/SL/statics/local/medire/WdatePicker.js"></script>
